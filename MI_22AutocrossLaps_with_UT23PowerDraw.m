...
endurance_results = zeros(length(simulated_endurance_data),8);
...
for i=1:7
    ...
    saveas(current_figure, "Plots/Michigan 22 Autocross Laps/" + string(Scount) + "S " + string(R_pack) + " ohm  MI 22 AutoX Laps " + plot_titles(i) + " Plot.png")
end