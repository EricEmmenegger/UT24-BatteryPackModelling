...
for i=1:7
    ...
    plot(time, data);
    title(plot_titles(i) + " in New Hampshire Endurance")
    xlabel("Time (seconds)")
    ylabel(plot_titles(i))
    saveas(current_figure, "Plots/New Hampshire Endurance/" + string(Scount) + "S " + string(R_pack) + " ohm NH Endurance " + plot_titles(i) + " Plot.png")
end