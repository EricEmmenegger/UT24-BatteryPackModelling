...
saveas(pack_voltage_plot,"Electrical Plots/New Hampshire Endurance/" + string(Scount) + "S " + string(R_pack) + " ohm NH Endurance Voltage Plot.png")
...
saveas(cell_voltage_plot,"Electrical Plots/New Hampshire Endurance/" + string(Scount) + "S " + string(R_pack) + " ohm NH Endurance Cell Voltage Plot.png")
...
xlabel("Time (seconds)")
ylabel("OCV")
saveas(ocv_plot,"Electrical Plots/New Hampshire Endurance/" + string(Scount) + "S " + string(R_pack) + " ohm NH Endurance OCV Plot.png")
...
xlabel("Time (seconds)")
ylabel("Current (A)")
saveas(current_plot,"Electrical Plots/New Hampshire Endurance/" + string(Scount) + "S " + string(R_pack) + " ohm NH Endurance Pack Current Plot.png")
...
xlabel("Time (seconds)")
ylabel("SOC (%)")
saveas(soc_plot,"Electrical Plots/New Hampshire Endurance/" + string(Scount) + "S " + string(R_pack) + " ohm NH Endurance Pack SOC Plot.png")
...
saveas(qgen_plot,"Heating Plots/New Hampshire Endurance/" + string(Scount) + "S " + string(R_pack) + " ohm NH Endurance Cell Heat Generation Plot.png")

T_plot = figure('visible','off','Units','centimeters','Position',[0 0 20 15]);
plot(endurance_results(:,1),endurance_results(:,7));
title("Adiabatic Cell Temperature in NH Endurance");
xlabel("Time (seconds")
ylabel("Cell Temperature (Celsius)")
saveas(T_plot,"Heating Plots/New Hampshire Endurance/" + string(Scount) + "S " + string(R_pack) + " ohm NH Endurance Cell Temperature Plot.png")